                                              ...
                                              <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                  <td class="content-block">
                                                    <span class="apple-link">Powered by SuperJackpot Lottery</span>
                                                  </td>
                                                </tr>
                                                <tr>
		                                              ...
		                                              <tr>
		                                                <td class="wrapper">
		                                                  <table border="0" cellpadding="0" cellspacing="0">
		                                                      ...
		                                                      <td>
		                                                        <p>Hey!</p>
		                                                        <p>Thank you participating! Scratch the cards and get your present!</p>
		                                                        <table border="0" cellpadding="0" cellspacing="0" >
		                                                          <tbody>
		                                                            <tr>
		                                                              <td align="left">
		                                                                <table border="0" cellpadding="0" cellspacing="0">
		                                                                  <tbody>
		                                                                    <tr>
		                                                                      <td> <a href="https://mysuperjackpot.com/" target="_blank" class="buy" style="padding-top: 8px;">Buy Another Ticket!</a> </td>
		                                                                    </tr>
		                                                                  </tbody>
		                                                                </table>
		                                                              </td>
    ...
    def post(self):
        ...
        if auth_token:
            ...
            if not isinstance(resp, str):
                ...
                bank = Bank.query.first()
                if (user != None and wallet.amount >= len(post_data['tickets'])):
                    if (post_data['type'] == "jackpot_5x36"):
	                    for c in post_data['tickets']:
	                        newBet = BetsJackpot_5_36(user.id, c['combination'], c['raffles'])
	                        db.session.add(newBet)
                    ...
                    if (post_data['type'] == "prize_jackpot"):
	                    for c in post_data['tickets']:
	                        ...
	                        bank.prize_jackpot += 1
	                        wallet.amount -= 1
                    msg = Message("SuperJackpot Lottery", sender = "superjackpot.noreply@gmail.com", recipients=[post_data['email']])
	                                                            ...
	                                                            <tr>
	                                                              <td align="left">
	                                                                <table border="0" cellpadding="0" cellspacing="0">
	                                                                  <tbody>
	                                                                    <tr>
	                                                                      <td> <a href="https://mysuperjackpot.com" target="_blank" class="buy" style="padding-top: 8px;">Get your present!</a> </td>
	                                                                    </tr>
	                                                                  </tbody>
	                                                                </table>
	                                                              </td>
                ...
                elif (wallet.amount < len(post_data['tickets'])):
                    responseObject = {
		                'status': 'fail',
		                'message': 'Sorry, you have not enough founds to present the tickets'
		            }
                    return make_response(jsonify(responseObject)), 401
                else:
                    for c in post_data['tickets']:
	                                                            ...
	                                                            <tr>
	                                                              <td align="left">
	                                                                <table border="0" cellpadding="0" cellspacing="0">
	                                                                  <tbody>
	                                                                    <tr>
	                                                                      <td> <a href="https://mysuperjackpot.com/register" target="_blank" class="buy" style="padding-top: 8px;">Register now!</a> </td>
	                                                                    </tr>
	                                                                  </tbody>
	                                                                </table>
	                                                              </td>
        ...
        if auth_token:
            ...
            if not isinstance(resp, str):
                ...
                if (user != None and wallet.amount >= post_data.get('tickets')):
	                                                ...
	                                                <td class="wrapper">
	                                                  <table border="0" cellpadding="0" cellspacing="0">
	                                                      ...
	                                                      <td>
	                                                        ...
	                                                        <p>Scratch the cards and get your prize!</p>
	                                                      </td>
	                                                      <td></td>
	                                                    </tr>
	                                                  </table>
                    ...
                    return make_response(jsonify(responseObject)), 200
                elif (wallet.amount < post_data['tickets']):
                    responseObject = {
		                'status': 'fail',
		                'message': 'Sorry, you have not enough founds to present the tickets'
		            }
